...
// @name           perseus-login
// @namespace      http://10.224.178.245:70/upower/PresentationLayer/Html/loginscr.uone
// @description    fill by platypus!
// @include        http://10.224.178.245:70/upower/PresentationLayer/Html/loginscr.uone
// ==/UserScript==

function do_platypus_script()
{
  d1 = document .title; // works 07-05-13 vvv
  document .title = "\u00a1" + d1
  do_modify_html_it
    ( window .document,
      document .evaluate
      ( '/HTML[1]/BODY[1]/FORM[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[4]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]',
	document, null, XPathResult .FIRST_ORDERED_NODE_TYPE, null 
	) .singleNodeValue,
      /<INPUT(.*) name="username\[(\d+)\]" /i,
      '<INPUT ($1) name="username[$2]" value="josef.kral@logicacmg.com"',
      null
      ); 
  do_modify_html_it
    ( window .document,
      document .evaluate
      ( '/HTML[1]/BODY[1]/FORM[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[4]/TD[1]/TABLE[1]/TBODY[1]/TR[3]/TD[2]',
	document, null, XPathResult .FIRST_ORDERED_NODE_TYPE, null 
	) .singleNodeValue,
      /<INPUT(.*) name=\"password/i,
      '<INPUT value="upower" name="password',
      null
      );
  document .evaluate
      ( '/HTML[1]/BODY[1]/FORM[1]/CENTER[1]/TABLE[1]/TBODY[1]/TR[5]/TD[1]/INPUT[1]',
	document, null, XPathResult .FIRST_ORDERED_NODE_TYPE, null 
	) .singleNodeValue .focus();
  document .title = "!" + d1; // + document .title;
};
